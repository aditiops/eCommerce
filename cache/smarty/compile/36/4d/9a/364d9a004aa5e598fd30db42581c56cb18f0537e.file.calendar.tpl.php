<?php /* Smarty version Smarty-3.1.14, created on 2013-10-22 19:34:52
         compiled from "/var/www/html/admin/themes/default/template/controllers/stats/calendar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20479190755266d35c3d4fe4-78567949%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '20479190755266d35c3d4fe4-78567949',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266d35e9ac195_15956165',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266d35e9ac195_15956165')) {function content_5266d35e9ac195_15956165($_smarty_tpl) {?>

<div id="statsContainer">
	<div id="calendar">
				<form action="<?php echo $_smarty_tpl->tpl_vars['current']->value;?>
&token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
<?php if ($_smarty_tpl->tpl_vars['action']->value&&$_smarty_tpl->tpl_vars['table']->value){?>&<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['action']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['table']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php if ($_smarty_tpl->tpl_vars['identifier']->value&&$_smarty_tpl->tpl_vars['id']->value){?>&<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['identifier']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php if (isset($_GET['module'])){?>&module=<?php echo htmlspecialchars($_GET['module'], ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php if (isset($_GET['id_product'])){?>&id_product=<?php echo htmlspecialchars($_GET['id_product'], ENT_QUOTES, 'ISO-8859-1', true);?>
