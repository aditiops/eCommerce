<?php /* Smarty version Smarty-3.1.14, created on 2013-10-22 19:33:58
         compiled from "/var/www/html/themes/default/modules/blockspecials/blockspecials.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13307753715266d326a98d35-28981930%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '988d01fe358f90bf959d7692ce722600b3d82f13' => 
    array (
      0 => '/var/www/html/themes/default/modules/blockspecials/blockspecials.tpl',
      1 => 1381148910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13307753715266d326a98d35-28981930',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266d329917aa2_66160052',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266d329917aa2_66160052')) {function content_5266d329917aa2_66160052($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/html/tools/smarty/plugins/modifier.escape.php';
...
<div id="special_block_right" class="block products_block exclusive blockspecials">
	<p class="title_block"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('prices-drop'), ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php if ($_smarty_tpl->tpl_vars['special']->value){?>
		<ul class="products clearfix">
			<li class="product_image">
				<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['special']->value['link'], ENT_QUOTES, 'ISO-8859-1', true);?>
"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['special']->value['link_rewrite'],$_smarty_tpl->tpl_vars['special']->value['id_image'],'medium_default'), ENT_QUOTES, 'ISO-8859-1', true);?>
...
%</span></span>
				...
				<?php }?>
					...
					<p class="s_title_block"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['special']->value['link'], ENT_QUOTES, 'ISO-8859-1', true);?>
" title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['special']->value['name'], 'html', 'UTF-8');?>
...
<?php }?></span>
		...
		<p>
			<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('prices-drop'), ENT_QUOTES, 'ISO-8859-1', true);?>
