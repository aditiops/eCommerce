<?php /* Smarty version Smarty-3.1.14, created on 2013-10-22 19:34:41
         compiled from "/var/www/html/themes/default/mobile/my-account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6510607555266d3514c2769-45789286%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af74bd4cd8e89144a29857a4ddf7b4885d16b5b2' => 
    array (
      0 => '/var/www/html/themes/default/mobile/my-account.tpl',
      1 => 1381148910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6510607555266d3514c2769-45789286',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266d3541da366_73954782',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266d3541da366_73954782')) {function content_5266d3541da366_73954782($_smarty_tpl) {?>
...
<div data-role="content" id="content">
		...
		<ul data-role="listview" data-inset="true" id="list_myaccount">
			...
			<li>
				<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" class="ui-li-icon ui-li-thumb" />
			...
			<?php }?>
			<li>
				<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('history',true), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" class="ui-li-icon ui-li-thumb" />
			...
			<li>
				<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-follow',true), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" class="ui-li-icon ui-li-thumb" />
			...
			<?php }?>
			<li>
				<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-slip',true), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" class="ui-li-icon ui-li-thumb" />
			...
			<li>
				<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('addresses',true), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" class="ui-li-icon ui-li-thumb" />
			...
			<li>
				<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('identity',true), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" class="ui-li-icon ui-li-thumb" />
			...
			<li>
				<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('discount',true), ENT_QUOTES, 'ISO-8859-1', true);?>
