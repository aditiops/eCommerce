...
<?php /*%%SmartyHeaderCode:5752661325266d31428dba4-37006334%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '5752661325266d31428dba4-37006334',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266d3185f2f02_03511931',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266d3185f2f02_03511931')) {function content_5266d3185f2f02_03511931($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/html/tools/smarty/plugins/modifier.escape.php';
?>
...
",
	...
	function searchCustomers()
	{
		$.ajax({
			type:"POST",
			url : "<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminOrders'), ENT_QUOTES, 'ISO-8859-1', true);?>
",
			async: true,
			dataType: "json",
			data : {
