<?php /* Smarty version Smarty-3.1.14, created on 2013-10-22 19:36:22
         compiled from "/var/www/html/themes/default/address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7009902075266d3b6a118a9-71801499%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0b65afd736cfe50404ad6189a15401e6c25b5d30' => 
    array (
      0 => '/var/www/html/themes/default/address.tpl',
      1 => 1381148910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7009902075266d3b6a118a9-71801499',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266d3bb4e8677_28507712',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266d3bb4e8677_28507712')) {function content_5266d3bb4e8677_28507712($_smarty_tpl) {?>
...
"
	<?php }else{ ?>
		<?php if (isset($_smarty_tpl->tpl_vars['address']->value->alias)){?>"<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->alias, ENT_QUOTES, 'ISO-8859-1', true);?>
"<?php }?>
	<?php }?>
<?php }else{ ?>
...
<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true), ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->dni)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->dni, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php }?>" />
...
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->company)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->company, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php }?>" />
		</p>
		<?php }?>
...
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->vat_number)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->vat_number, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php }?>" />
					</p>
				</div>
			</div>
...
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->firstname)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->firstname, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php }?>" />
		</p>
		<?php }?>
...
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->lastname)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->lastname, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php }?>" />
		</p>
		<?php }?>
...
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->address1)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->address1, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php }?>" />
		</p>
		<?php }?>
...
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->address2)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->address2, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php }?>" />
		</p>
		<?php }?>
...
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->postcode)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->postcode, ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->city)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->city, ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->other)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->other, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php }?></textarea>
		</p>
...
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->phone)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->phone, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php }?>" />
		</p>
...
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->phone_mobile)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->phone_mobile, ENT_QUOTES, 'ISO-8859-1', true);?>
<?php }?><?php }?>" />
		</p>
...
<?php }elseif(isset($_smarty_tpl->tpl_vars['address']->value->alias)){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->alias, ENT_QUOTES, 'ISO-8859-1', true);?>
