<?php /* Smarty version Smarty-3.1.14, created on 2013-10-22 19:34:30
         compiled from "/var/www/html/themes/default/order-carrier.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4084965285266d3469defb3-26542480%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bcb5fcf76cc4bc29eb401d5bfa1a726582c0f434' => 
    array (
      0 => '/var/www/html/themes/default/order-carrier.tpl',
      1 => 1381148910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4084965285266d3469defb3-26542480',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266d350dd2e29_70497227',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266d350dd2e29_70497227')) {function content_5266d350dd2e29_70497227($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/html/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php if (!$_smarty_tpl->tpl_vars['opc']->value){?>
	...
	<form id="form" action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"multi-shipping=".((string)$_smarty_tpl->tpl_vars['multi_shipping']->value)), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" />
		<?php if (!$_smarty_tpl->tpl_vars['is_guest']->value){?>
			<?php if ($_smarty_tpl->tpl_vars['back']->value){?>
				<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"step=1&back=".((string)$_smarty_tpl->tpl_vars['back']->value)."&multi-shipping=".((string)$_smarty_tpl->tpl_vars['multi_shipping']->value)), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" class="button">&laquo; <?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
			...
			<?php }else{ ?>
				<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"step=1&multi-shipping=".((string)$_smarty_tpl->tpl_vars['multi_shipping']->value)), ENT_QUOTES, 'ISO-8859-1', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
" class="button">&laquo; <?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</a>
			<?php }?>
		<?php }else{ ?>
				<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"multi-shipping=".((string)$_smarty_tpl->tpl_vars['multi_shipping']->value)), ENT_QUOTES, 'ISO-8859-1', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
" class="button">&laquo; <?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</a>
		<?php }?>
