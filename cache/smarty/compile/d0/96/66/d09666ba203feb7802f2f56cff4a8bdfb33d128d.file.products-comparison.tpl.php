<?php /* Smarty version Smarty-3.1.14, created on 2013-10-22 19:34:03
         compiled from "/var/www/html/themes/default/products-comparison.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6456169875266d32b848e39-50758029%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd09666ba203feb7802f2f56cff4a8bdfb33d128d' => 
    array (
      0 => '/var/www/html/themes/default/products-comparison.tpl',
      1 => 1381148910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6456169875266d32b848e39-50758029',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266d33134a049_63352915',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266d33134a049_63352915')) {function content_5266d33134a049_63352915($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/html/tools/smarty/plugins/modifier.escape.php';
...
" class="product_image" >
					<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['product']->value->id_image,'home_default'), ENT_QUOTES, 'ISO-8859-1', true);?>
...
"><?php echo smartyTranslate(array('s'=>'View'),$_smarty_tpl);?>
 ...
 <?php echo smartyTranslate(array('s'=>'per %s','sprintf'=>smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->unity, 'htmlall', 'UTF-8')),$_smarty_tpl);?>
				...
				<a class="cmp_remove" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('products-comparison',true), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"qty=1&amp;id_product=".((string)$_smarty_tpl->tpl_vars['product']->value->id)."&amp;token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)."&amp;add"), ENT_QUOTES, 'ISO-8859-1', true);?>
