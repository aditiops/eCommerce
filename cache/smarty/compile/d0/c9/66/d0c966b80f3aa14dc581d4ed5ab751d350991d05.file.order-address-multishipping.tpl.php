<?php /* Smarty version Smarty-3.1.14, created on 2013-10-22 19:34:09
         compiled from "/var/www/html/themes/default/order-address-multishipping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8984295355266d33134d2f5-15767238%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd0c966b80f3aa14dc581d4ed5ab751d350991d05' => 
    array (
      0 => '/var/www/html/themes/default/order-address-multishipping.tpl',
      1 => 1381148910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8984295355266d33134d2f5-15767238',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266d3348ec518_55530885',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266d3348ec518_55530885')) {function content_5266d3348ec518_55530885($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/html/tools/smarty/plugins/function.counter.php';
...
<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'multi-shipping=1'), ENT_QUOTES, 'ISO-8859-1', true);?>
" method="post">
<?php }else{ ?>
...
<?php }?><?php $_tmp4=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp3.$_tmp4), ENT_QUOTES, 'ISO-8859-1', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
...
" />
		<?php if ($_smarty_tpl->tpl_vars['back']->value){?>
			<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"step=0&amp;back=".((string)$_smarty_tpl->tpl_vars['back']->value)), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" class="button">&laquo; <?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
		...
		<?php }else{ ?>
			<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"step=0"), ENT_QUOTES, 'ISO-8859-1', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
" class="button">&laquo; <?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</a>
		<?php }?>
