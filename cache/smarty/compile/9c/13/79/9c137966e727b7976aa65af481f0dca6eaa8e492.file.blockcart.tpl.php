<?php /* Smarty version Smarty-3.1.14, created on 2013-10-22 19:35:09
         compiled from "/var/www/html/themes/default/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6275402845266d36d59e586-98441341%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9c137966e727b7976aa65af481f0dca6eaa8e492' => 
    array (
      0 => '/var/www/html/themes/default/modules/blockcart/blockcart.tpl',
      1 => 1381148910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6275402845266d36d59e586-98441341',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266d373f2fc15_78764934',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266d373f2fc15_78764934')) {function content_5266d373f2fc15_78764934($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/html/tools/smarty/plugins/modifier.escape.php';
...
<div id="cart_block" class="block exclusive">
	<p class="title_block">
		<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php $_tmp2=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp1."&amp;ipa=".$_tmp2."&amp;id_customization=".((string)$_smarty_tpl->tpl_vars['id_customization']->value)."&amp;token=".((string)$_smarty_tpl->tpl_vars['static_token']->value),true), ENT_QUOTES, 'ISO-8859-1', true);?>
" rel="nofollow"> </a></div>
...
<?php }?></span>
		...
		<?php }?>
		<p id="cart-buttons">
			<?php if ($_smarty_tpl->tpl_vars['order_process']->value=='order'){?><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'ISO-8859-1', true);?>
