<?php /* Smarty version Smarty-3.1.14, created on 2013-10-22 19:34:47
         compiled from "/var/www/html/themes/default/sitemap.tpl" */ ?>
<?php /*%%SmartyHeaderCode:365215745266d3576e78a3-89737795%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '52f701623dd94896ba475b35ab85aa03f238aea0' => 
    array (
      0 => '/var/www/html/themes/default/sitemap.tpl',
      1 => 1381148910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '365215745266d3576e78a3-89737795',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266d35b5d6c53_40984926',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266d35b5d6c53_40984926')) {function content_5266d35b5d6c53_40984926($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/html/tools/smarty/plugins/modifier.escape.php';
?>
...
"><?php echo smartyTranslate(array('s'=>'New products'),$_smarty_tpl);?>
			...
			<li><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('best-sales'), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'Order history'),$_smarty_tpl);?>
		...
		<?php }else{ ?>
			<li><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true), ENT_QUOTES, 'ISO-8859-1', true);?>
...
"><?php echo smartyTranslate(array('s'=>'Contact'),$_smarty_tpl);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['display_store']->value){?><li class="last"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('stores'), ENT_QUOTES, 'ISO-8859-1', true);?>
