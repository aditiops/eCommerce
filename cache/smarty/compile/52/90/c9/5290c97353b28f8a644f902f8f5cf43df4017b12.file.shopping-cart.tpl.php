<?php /* Smarty version Smarty-3.1.14, created on 2013-10-22 19:35:45
         compiled from "/var/www/html/themes/default/mobile/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17190171335266d391a6ead8-01033550%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5290c97353b28f8a644f902f8f5cf43df4017b12' => 
    array (
      0 => '/var/www/html/themes/default/mobile/shopping-cart.tpl',
      1 => 1381148910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17190171335266d391a6ead8-01033550',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266d3976e79f1_67729414',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266d3976e79f1_67729414')) {function content_5266d3976e79f1_67729414($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['empty']->value)){?>
...
<?php $_tmp3=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp1."&amp;ipa=".$_tmp2."&amp;id_address_delivery=".$_tmp3."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php $_tmp6=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp4."&amp;ipa=".$_tmp5."&amp;id_address_delivery=".$_tmp6."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php }?></h3>
		...
		<?php if ($_smarty_tpl->tpl_vars['opc']->value&&$_smarty_tpl->tpl_vars['isLogged']->value&&!$_smarty_tpl->tpl_vars['isGuest']->value){?>
			<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('index',true), ENT_QUOTES, 'ISO-8859-1', true);?>
